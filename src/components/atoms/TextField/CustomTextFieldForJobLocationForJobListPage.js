      ...
      <div data-testid="1stdivinselect">
        <ThemeProvider theme={customtheme}>
          <div {...getRootProps()} data-testid="2nddivinselect">
            ...
            <InputWrapper data-testid="inputwrapperinselect" ref={setAnchorEl} className={focused ? 'focused' : ''} placeholder="Search">
              <div className={classes.header} data-testid="3rddivinselect">
                <img data-testid="imginselect" src={"https://cdn.zeplin.io/5fa28fcbff79c58958e4e1a6/assets/59f5b11c-e6c7-496b-8139-44d5ef4578ce.svg"} width='24px' height='24px' />
              </div>
