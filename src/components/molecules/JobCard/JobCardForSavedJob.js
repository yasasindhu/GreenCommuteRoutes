...
import { showJobForSavedJobs } from "../../../store/actions/actions";
...
export default function JobCardForSavedJob({
	// logo,
	// roleName,
	// companyName,
	// location,
	...
	const handleChangeForCard = () =>{
		dispatch(showJobForSavedJobs(job)), 
		history.push('/showSavedJobsDescription')
	}
