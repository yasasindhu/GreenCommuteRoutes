...
export default function SearchJobPage(){
    ...
    const stateForRenderingCardsInSearchJob = useSelector((state) => {console.log("state",state); return state.jobs})
    console.log("In SavedJobList ", stateForRenderingCardsInSearchJob)
    const jobsInSavedJobs = stateForRenderingCardsInSearchJob.jobsInSavedJobs
    console.log("In SavedJobsList")
    console.log(stateForRenderingCardsInSearchJob.jobsInSavedJobs)
